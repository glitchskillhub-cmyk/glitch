          ...
          {!user ? (
            ...
            <>
              ...
              <div 
                ...
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-red-600 px-6 py-2 text-xs font-semibold tracking-wide text-white hover:bg-red-700 transition-all duration-200 cursor-pointer select-none group ml-2"
                role="button"
                tabIndex={0}
              >
                <LogOut size={14} />
