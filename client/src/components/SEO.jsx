...
const SEO = ({ title, description, keywords, type = 'website', path = '' }) => {
  ...
  const defaultDescription = 'Glitch Skill Hub provides premium skill programs and hands-on software engineering courses to teach you real-time, practical skills.';
  ...
  const siteUrl = 'https://www.glitchedu.online';
