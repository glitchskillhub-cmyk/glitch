...
const Contact = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "We do more than that. We provide direct referrals, resume building by MNC leads, and intensive mock interviews to ensure you're ready for the real deal."
    },
    {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-56 pb-24 relative overflow-hidden bg-slate-950 text-white">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="badge-modern mx-auto mb-8 border-white/10 text-white"><span></span> Get in Touch</div>
              ...
              <div className="space-y-8">
                {[
                  ...
                  <div key={i} className="flex items-start gap-6 group">
                    <div className="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center text-slate-900 shrink-0 group-hover:bg-primary transition-colors">
                      <item.icon size={28} />
                    </div>
                    <div>
               ...
               <form className="space-y-8 relative z-10">
                  ...
                  <div className="floating-label-group m-0">
                    <select 
                      ...
                      onChange={handleChange}
                      className={`input-field appearance-none ${formData.subject ? 'select-active' : ''}`}
                    >
      ...
      <section className="py-32 bg-slate-50">
        <div className="container mx-auto px-6">
           ...
           <div className="max-w-4xl mx-auto space-y-4">
              {faqs.map((faq, i) => (
                <div key={i} className="bento-card bg-white p-8 group hover:border-primary cursor-pointer">
