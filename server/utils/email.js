...
const sendReceiptEmail = async (studentDetails, paymentDetails) => {
  ...
  const mailOptions = {
    from: `"SV IT Solutions" <${process.env.EMAIL_USER}>`,
    to: studentDetails.email,
    subject: 'Payment Successful - SV IT Solutions',
...
- Status: Successful`,
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;">
        ...
        <p style="font-size: 12px; color: #666; margin-top: 20px;">© 2026 SV IT Solutions Private Limited</p>
      </div>
    `,
  };
